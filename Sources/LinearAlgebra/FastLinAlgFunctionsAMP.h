...
namespace LinearAlgebra {
	...
	namespace Internal {
		...
		struct MatrixEntryAMP
		{
			...
			{
				MatrixEntryAMP< T, m, n, p, row, col, i - 1 >::Get< type >( A, B, entry );
			...
			{
				MatrixEntryAMP< T, m, n, p, row, col, i - 1 >::Get< MatrixMultiplicationType::A_TRANSPOSED >( A, B, entry );
			...
			{
				MatrixEntryAMP< T, m, n, p, row, col, i - 1 >::Get< MatrixMultiplicationType::B_TRANSPOSED >( A, B, entry );
			...
			{
				MatrixEntryAMP< T, m, n, p, row, col, i - 1 >::Get< MatrixMultiplicationType::BOTH_TRANSPOSED >( A, B, entry );
				( *entry ) += ( ELEMENT( A, n * i + row ) * ELEMENT( B, m * col + i ) );
			}
		};
		
		template < typename T, uint m, uint n, uint p, uint row, uint col >
		struct MatrixEntryAMP< T, m, n, p, row, col, 0 >
		{
			template < MatrixMultiplicationType type = MatrixMultiplicationType::NORMAL >
			static __forceinline void Get( __in_ecount( m * n ) const T* A, __in_ecount( n * p ) const T* B, __out T* entry ) restrict( amp )
			{
		...
		struct MatrixRowAMP
		{
			...
			{
				MatrixEntryAMP< T, m, n, p, row, col, n - 1 >::Get< type >( A, B, C + ( p * row + col ) );
				MatrixRowAMP< T, m, n, p, row, col - 1 >::Get< type >( A, B, C );
			}
			...
			{
				MatrixEntryAMP< T, m, n, p, row, col, m - 1 >::Get< MatrixMultiplicationType::A_TRANSPOSED >( A, B, C + ( p * row + col ) );
				MatrixRowAMP< T, m, n, p, row, col - 1 >::Get< MatrixMultiplicationType::A_TRANSPOSED >( A, B, C );
			}
			...
			{
				MatrixEntryAMP< T, m, n, p, row, col, n - 1 >::Get< MatrixMultiplicationType::B_TRANSPOSED >( A, B, C + ( p * row + col ) );
				MatrixRowAMP< T, m, n, p, row, col - 1 >::Get< MatrixMultiplicationType::B_TRANSPOSED >( A, B, C );
			}
			...
			{
				MatrixEntryAMP< T, m, n, p, row, col, m - 1 >::Get< MatrixMultiplicationType::BOTH_TRANSPOSED >( A, B, C + ( p * row + col ) );
				MatrixRowAMP< T, m, n, p, row, col - 1 >::Get< MatrixMultiplicationType::BOTH_TRANSPOSED >( A, B, C );
			}
		};
		
		template < typename T, uint m, uint n, uint p, uint row >
		struct MatrixRowAMP< T, m, n, p, row, 0 >
		{
			template < MatrixMultiplicationType type = MatrixMultiplicationType::NORMAL >
			static __forceinline void Get( __in_ecount( m * n ) const T* A, __in_ecount( n * p ) const T* B, __out_ecount( m * p ) T* C ) restrict( amp )
			{
				MatrixEntryAMP< T, m, n, p, row, 0, n - 1 >::Get< type >( A, B, C + ( p * row ) );
				MatrixRowAMP< T, m, n, p, row - 1, p - 1 >::Get< type >( A, B, C );
			}
		
			template <>
			static __forceinline void Get< MatrixMultiplicationType::A_TRANSPOSED >( __in_ecount( m * n ) const T* A, __in_ecount( m * p ) const T* B, __out_ecount( n * p ) T* C ) restrict( amp )
			{
				MatrixEntryAMP< T, m, n, p, row, 0, m - 1 >::Get< MatrixMultiplicationType::A_TRANSPOSED >( A, B, C + ( p * row ) );
				MatrixRowAMP< T, m, n, p, row - 1, p - 1 >::Get< MatrixMultiplicationType::A_TRANSPOSED >( A, B, C );
			}
		
			template <>
			static __forceinline void Get< MatrixMultiplicationType::B_TRANSPOSED >( __in_ecount( m * n ) const T* A, __in_ecount( p * n ) const T* B, __out_ecount( m * p ) T* C ) restrict( amp )
			{
				MatrixEntryAMP< T, m, n, p, row, 0, n - 1 >::Get< MatrixMultiplicationType::B_TRANSPOSED >( A, B, C + ( p * row ) );
				MatrixRowAMP< T, m, n, p, row - 1, p - 1 >::Get< MatrixMultiplicationType::B_TRANSPOSED >( A, B, C );
			}
		
			template <>
			static __forceinline void Get< MatrixMultiplicationType::BOTH_TRANSPOSED >( __in_ecount( m * n ) const T* A, __in_ecount( p * m ) const T* B, __out_ecount( n * p ) T* C ) restrict( amp )
			{
				MatrixEntryAMP< T, m, n, p, row, 0, m - 1 >::Get< MatrixMultiplicationType::BOTH_TRANSPOSED >( A, B, C + ( p * row ) );
				MatrixRowAMP< T, m, n, p, row - 1, p - 1 >::Get< MatrixMultiplicationType::BOTH_TRANSPOSED >( A, B, C );
			}
		};
		
		template < typename T, uint m, uint n, uint p  >
		struct MatrixRowAMP< T, m, n, p, 0, 0 >
		{
			template < MatrixMultiplicationType type = MatrixMultiplicationType::NORMAL >
			static __forceinline void Get( __in_ecount( m * n ) const T* A, __in_ecount( n * p ) const T* B, __out_ecount( m * p ) T* C ) restrict( amp )
			{
				MatrixEntryAMP< T, m, n, p, 0, 0, n - 1 >::Get< type >( A, B, C );
			}
		
			template <>
			static __forceinline void Get< MatrixMultiplicationType::A_TRANSPOSED >( __in_ecount( m * n ) const T* A, __in_ecount( m * p ) const T* B, __out_ecount( n * p ) T* C ) restrict( amp )
			{
				MatrixEntryAMP< T, m, n, p, 0, 0, m - 1 >::Get< MatrixMultiplicationType::A_TRANSPOSED >( A, B, C );
			}
		
			template <>
			static __forceinline void Get< MatrixMultiplicationType::B_TRANSPOSED >( __in_ecount( m * n ) const T* A, __in_ecount( p * n ) const T* B, __out_ecount( m * p ) T* C ) restrict( amp )
			{
				MatrixEntryAMP< T, m, n, p, 0, 0, n - 1 >::Get< MatrixMultiplicationType::B_TRANSPOSED >( A, B, C );
			}
		
			template <>
			static __forceinline void Get< MatrixMultiplicationType::BOTH_TRANSPOSED >( __in_ecount( m * n ) const T* A, __in_ecount( p * m ) const T* B, __out_ecount( n * p ) T* C ) restrict( amp )
			{
				MatrixEntryAMP< T, m, n, p, 0, 0, m - 1 >::Get< MatrixMultiplicationType::BOTH_TRANSPOSED >( A, B, C );
			}
		};
	...
	namespace Internal {
		...
		struct MatrixIteratorAMP
		{
			static __forceinline void Add( __in_ecount( m * n ) const T* A, __in_ecount( m * n ) const T* B, __out_ecount( m * n ) T* C ) restrict( amp )
			{
				...
				MatrixIteratorAMP< T, m, n, row, col - 1 >::Add( A, B, C );
			}
			...
			{
				ELEMENT( C, row * n + col ) = ELEMENT( A, row * n + col ) - ( cnst * ELEMENT( B, row * n + col ) );
				MatrixIteratorAMP< T, m, n, row, col - 1 >::SubtractC( A, B, cnst, C );
			}
			...
			{
				ELEMENT( C, row * n + col ) = ELEMENT( A, row * n + col ) * ELEMENT( B, row * n + col );
				MatrixIteratorAMP< T, m, n, row, col - 1 >::MulElementWise( A, B, C );
			}
			...
			static __forceinline void MultiplyByCnst( __in_ecount( m * n ) const T* A, __in const T cnst, __out_ecount( m * n ) T* B ) restrict( amp )
			{
				...
				MatrixIteratorAMP< T, m, n, row, col - 1 >::MultiplyByCnst( A, cnst, B );
			}
		
			static __forceinline T FrobeniusNorm( __in_ecount( m * n ) const T* A ) restrict( amp )
			{
				return MatrixIteratorAMP< T, m, n, row, col - 1 >::FrobeniusNorm( A ) + ( ELEMENT( A, row * n + col ) * ELEMENT( A, row * n + col ) );
			}
		
			static __forceinline void Negate( __in_ecount( m * n ) const T* A, __out_ecount( m * n ) T* B ) restrict( amp )
			{
				MatrixIteratorAMP< T, m, n, row, col - 1 >::Negate( A, B );
				ELEMENT( B, row * n + col ) = -ELEMENT( A, row * n + col );
			}
		};
		
		template < typename T, uint m, uint n, uint row >
		struct MatrixIteratorAMP< T, m, n, row, 0 >
		{
			static __forceinline void Add( __in_ecount( m * n ) const T* A, __in_ecount( m * n ) const T* B, __out_ecount( m * n ) T* C ) restrict( amp )
			{
				ELEMENT( C, row * n ) = ELEMENT( A, row * n ) + ELEMENT( B, row * n );
				MatrixIteratorAMP< T, m, n, row - 1, n - 1 >::Add( A, B, C );
			}
		
			static __forceinline void AddC( __in_ecount( m * n ) const T* A, __in_ecount( m * n ) const T* B, __in const T cnst, __out_ecount( m * n ) T* C ) restrict( amp )
			{
				ELEMENT( C, row * n ) = ELEMENT( A, row * n ) + ( cnst * ELEMENT( B, row * n ) );
				MatrixIteratorAMP< T, m, n, row - 1, n - 1 >::AddC( A, B, cnst, C );
			}
		
			static __forceinline void Subtract( __in_ecount( m * n ) const T* A, __in_ecount( m * n ) const T* B, __out_ecount( m * n ) T* C ) restrict( amp )
			{
				ELEMENT( C, row * n ) = ELEMENT( A, row * n ) - ELEMENT( B, row * n );
				MatrixIteratorAMP< T, m, n, row - 1, n - 1 >::Subtract( A, B, C );
			}
		
			static __forceinline void SubtractC( __in_ecount( m * n ) const T* A, __in_ecount( m * n ) const T* B, __in const T cnst, __out_ecount( m * n ) T* C ) restrict( amp )
			{
				ELEMENT( C, row * n ) = ELEMENT( A, row * n ) - ( cnst * ELEMENT( B, row * n ) );
				MatrixIteratorAMP< T, m, n, row - 1, n - 1 >::SubtractC( A, B, cnst, C );
			}
		
			static __forceinline void MulElementWise( __in_ecount( m * n ) const T* A, __in_ecount( m * n ) const T* B, __out_ecount( m * n ) T* C ) restrict( amp )
			{
				ELEMENT( C, row * n ) = ELEMENT( A, row * n ) * ELEMENT( B, row * n );
				MatrixIteratorAMP< T, m, n, row - 1, n - 1 >::MulElementWise( A, B, C );
			}
		
			static __forceinline void MultiplyByCnst( __in_ecount( m * n ) const T* A, __in const T cnst, __out_ecount( m * n ) T* B ) restrict( amp )
			{
				ELEMENT( B, row * n ) = ELEMENT( A, row * n ) * cnst;
				MatrixIteratorAMP< T, m, n, row - 1, n - 1 >::MultiplyByCnst( A, cnst, B );
			}
		
			static __forceinline T FrobeniusNorm( __in_ecount( m * n ) const T* A ) restrict( amp )
			{
				return MatrixIteratorAMP< T, m, n, row - 1, n - 1 >::FrobeniusNorm( A ) + ( ELEMENT( A, row * n ) * ELEMENT( A, row * n ) );
			}
		
			static __forceinline void Negate( __in_ecount( m * n ) const T* A, __out_ecount( m * n ) T* B ) restrict( amp )
			{
				MatrixIteratorAMP< T, m, n, row - 1, n - 1 >::Negate( A, B );
				ELEMENT( B, row * n ) = -ELEMENT( A, row * n );
			}
		};
		
		template < typename T, uint m, uint n >
		struct MatrixIteratorAMP< T, m, n, 0, 0 >
		{
			static __forceinline void Add( __in_ecount( m * n ) const T* A, __in_ecount( m * n ) const T* B, __out_ecount( m * n ) T* C ) restrict( amp )
			{
	...
	namespace Internal {
		...
		template < typename T, uint n >
		struct MatrixDiagonalIteratorAMP
		{
			static __forceinline void SetTo( __in const T cnst, __out_ecount( n * n ) T* A ) restrict( amp )
			{
				MatrixDiagonalIteratorAMPImpl< T, n, n - 1 >::SetTo( cnst, A );
			}
		
			static __forceinline void MultiplyBy( __in const T cnst, __inout_ecount( n * n ) T* A ) restrict( amp )
			{
				MatrixDiagonalIteratorAMPImpl< T, n, n - 1 >::MultiplyBy( cnst, A );
			}
		};
	...
	{
		Internal::MatrixRowAMP< T, m, n, p, m - 1, p - 1 >::Get< Internal::MatrixMultiplicationType::NORMAL >( A, B, C );
	}
	...
	{
		Internal::MatrixRowAMP< T, m, n, p, n - 1, p - 1 >::Get< Internal::MatrixMultiplicationType::A_TRANSPOSED >( A, B, C );
	}
	...
	{
		Internal::MatrixRowAMP< T, m, n, p, m - 1, p - 1 >::Get< Internal::MatrixMultiplicationType::B_TRANSPOSED >( A, B, C );
	}
	...
	{
		Internal::MatrixRowAMP< T, m, n, p, n - 1, p - 1 >::Get< Internal::MatrixMultiplicationType::BOTH_TRANSPOSED >( A, B, C );
	}
	
	template < typename T, uint m, uint n >
	__forceinline void MatrixAdd( __in_ecount( m * n ) const T* A, __in_ecount( m * n ) const T* B, __out_ecount( m * n ) T* C ) restrict( amp )
	{
		Internal::MatrixIteratorAMP< T, m, n, m - 1, n - 1 >::Add( A, B, C );
	}
	...
	{
		Internal::MatrixIteratorAMP< T, m, n, m - 1, n - 1 >::SubtractC( A, B, cnst, C );
	}
	...
	{
		Internal::MatrixIteratorAMP< T, m, n, m - 1, n - 1 >::MulElementWise( A, B, C );
	}
