...
namespace LinearAlgebra {
	...
	template < typename T >
	__forceinline void M33Zero( __out_ecount( 9 ) T* M ) restrict( amp )
	{
		Containers::ArrayUtils< T >::Fill< 9 >( T( 0 ), M );
	}
	
	template < typename T >
	__forceinline void M33Identity( __out_ecount( 9 ) T* M ) restrict( amp )
	{
		M33Zero( M );
		ELEMENT( M, 0 ) = T( 1 );
		ELEMENT( M, 4 ) = T( 1 );
	...
	__forceinline void M33Neg( __in_ecount( 9 ) const T1* M, __out_ecount( 16 ) T2* oM ) restrict( amp )
	{
	...
	__forceinline void M33AddM33( __in_ecount( 9 ) const T1* M, __in_ecount( 9 ) const T2* K, __out_ecount( 9 ) T3* oM ) restrict( amp )
	{
	...
	template < typename T1, typename T2, typename T3 >
	__forceinline void M33SubM33( __in_ecount( 9 ) const T1* M, __in_ecount( 9 ) const T2* K, __out_ecount( 9 ) T3* oM ) restrict( amp )
	{
		ELEMENT( oM, 0 ) = ELEMENT( M, 0 ) - ELEMENT( K, 0 );
		ELEMENT( oM, 1 ) = ELEMENT( M, 1 ) - ELEMENT( K, 1 );
		ELEMENT( oM, 2 ) = ELEMENT( M, 2 ) - ELEMENT( K, 2 );
	...
	template < typename T1, typename T2, typename T3 >
	__forceinline void M33MulC( __in_ecount( 9 ) const T1* M, __in const T2 c, __out_ecount( 9 ) T3* oM ) restrict( amp )
	{
	...
	template < typename T1, typename T2, typename T3 >
	__forceinline void M33MulV3( __in_ecount( 9 ) const T1* M, __in_ecount( 3 ) const T2* iv, __out_ecount( 3 ) T3* ov ) restrict( amp )
	{
	...
	template < typename T1, typename T2, typename T3 >
	__forceinline void M33MulM33( __in_ecount( 9 ) const T1* M, __in_ecount( 9 ) const T2* K, __out_ecount( 3 ) T3* oM ) restrict( amp )
	{
	...
	__forceinline T1 M33Det( __in_ecount( 9 ) const T1* M ) restrict( amp )
	{
		return (
	...
	template < typename T1, typename T2 >
	__forceinline void M33Inverse( __in_ecount( 9 ) const T1* M, __out_ecount( 9 ) T2* MI ) restrict( amp )
	{
	...
	template< typename T1 >
	__forceinline T1 M33Trace( __in_ecount( 9 ) const T1* M ) restrict( amp )
	{
		return ELEMENT( M, 0 ) + ELEMENT( M, 4 ) + ELEMENT( M, 8 );
	}
	
	template < typename T1, typename T2 >
	__forceinline void M33Transpose( __in_ecount( 9 ) const T1* M, __out_ecount( 3 ) T2* oM ) restrict( amp )
	{
		ELEMENT( oM, 0 ) = ELEMENT( M, 0 );
