...
namespace LinearAlgebra {
	...
	template < typename T >
	__forceinline void M44Zero( __out_ecount( 16 ) T* M ) restrict( amp )
	{
		Containers::ArrayUtils< T >::Fill< 16 >( T( 0 ), M );
	}
	
	template < typename T >
	__forceinline void M44Identity( __out_ecount( 9 ) T* M ) restrict( amp )
	{
		M44Zero( M );
		ELEMENT( M, 0 ) = T( 1 );
		ELEMENT( M, 5 ) = T( 1 );
	...
	__forceinline void M44Neg( __in_ecount( 16 ) const T1* M, __out_ecount( 16 ) T2* oM ) restrict( amp )
	{
	...
	__forceinline void M44AddM44( __in_ecount( 16 ) const T1* M, __in_ecount( 16 ) const T2* K, __out_ecount( 16 ) T3* oM ) restrict( amp )
	{
	...
	template < typename T1, typename T2, typename T3 >
	__forceinline void M44SubM44( __in_ecount( 16 ) const T1* M, __in_ecount( 16 ) const T2* K, __out_ecount( 16 ) T3* oM ) restrict( amp )
	{
		ELEMENT( oM, 0 ) = ELEMENT( M, 0 ) - ELEMENT( K, 0 );
		ELEMENT( oM, 1 ) = ELEMENT( M, 1 ) - ELEMENT( K, 1 );
		ELEMENT( oM, 2 ) = ELEMENT( M, 2 ) - ELEMENT( K, 2 );
	...
	template < typename T1, typename T2, typename T3 >
	__forceinline void M44MulC( __in_ecount( 16 ) const T1* M, __in const T2 c, __out_ecount( 16 ) T3* oM ) restrict( amp )
	{
	...
	template < typename T1, typename T2, typename T3 >
	__forceinline void M44MulV4( __in_ecount( 16 ) const T1* M, __in_ecount( 4 ) const T2* inV, __out_ecount( 4 ) T3* outV ) restrict( amp )
	{
	...
	template < typename T1, typename T2, typename T3 >
	__forceinline void M44MulM44( __in_ecount( 16 ) const T1* M, __in_ecount( 16 ) const T2* K, __out_ecount( 16 ) T3* oM ) restrict( amp )
	{
	...
	__forceinline T1 M44Trace( __in_ecount( 16 ) const T1* M ) restrict( amp )
	{
		return ELEMENT( M, 0 ) + ELEMENT( M, 5 ) + ELEMENT( M, 10 ) + ELEMENT( M, 15 );
	}
	
	template < typename T1, typename T2 >
	__forceinline void M44Transpose( __in_ecount( 9 ) const T1* M, __out_ecount( 3 ) T2* oM ) restrict( amp )
	{
		ELEMENT( oM, 0 ) = ELEMENT( M, 0 );
