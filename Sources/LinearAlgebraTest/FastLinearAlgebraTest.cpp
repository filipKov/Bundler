...
namespace LinearAlgebraTest {
	...
	TEST_CLASS( FastMatrixInversionTest )
	{
		...
		TEST_METHOD( MatrixInvert7x7 )
		{
			double M[49] = {
				0.287508, 0.0519538, 0.0389154, 0.529358, 0.382753, 0.143824, 0.277033,
				0.14453, 0.686433, 0.0544151, 0.215136, 0.954985, 0.288891, 0.864683,
				0.0507786, 0.59256, 0.824005, 0.6584, 0.382724, 0.412015, 0.767931,
				0.531103, 0.561234, 0.239858, 0.315385, 0.101567, 0.673203, 0.619234,
				0.237793, 0.187471, 0.127436, 0.790696, 0.401694, 0.578006, 0.309789,
				0.246622, 0.345836, 0.589909, 0.240008, 0.494459, 0.309083, 0.977467,
				0.599588, 0.00797969, 0.615485, 0.502735, 0.902768, 0.473428, 0.211668 };

			TestInverse< double, 7 >( M );
		}

		TEST_METHOD( MatrixInvert10x10 )
		{
			double M[100] = {
				0.445356, 0.149549, 0.837978, 0.542875, 0.8668, 0.86734, 0.149997, 0.973244, 0.0240157, 0.898928,
				0.623209, 0.897471, 0.965051, 0.538636, 0.484395, 0.368528, 0.747179, 0.638155, 0.786596, 0.432414,
				0.898145, 0.672385, 0.495458, 0.935961, 0.848397, 0.716545, 0.27105, 0.445451, 0.78199, 0.842181,
				0.343629, 0.389056, 0.895953, 0.278364, 0.622425, 0.0511747, 0.500518, 0.455906, 0.208067, 0.320202,
				0.874193, 0.265328, 0.446999, 0.453259, 0.217503, 0.392033, 0.178399, 0.802115, 0.985138, 0.319869,
				0.640347, 0.527709, 0.846598, 0.0530804, 0.635162, 0.828951, 0.764702, 0.75553, 0.650655, 0.664913,
				0.495983, 0.503489, 0.137281, 0.909485, 0.302831, 0.830268, 0.0231608, 0.0945859, 0.212149, 0.463757,
				0.114291, 0.919267, 0.459524, 0.642216, 0.626249, 0.199996, 0.91564, 0.801911, 0.0385505, 0.0863217,
				0.663729, 0.430825, 0.865785, 0.271574, 0.727617, 0.493859, 0.821958, 0.131794, 0.768632, 0.589931,
				0.246846, 0.61723, 0.23336, 0.533707, 0.868551, 0.767881, 0.873886, 0.501485, 0.814712, 0.845362 };

			TestInverse< double, 10 >( M );
		}
		
		// TEST_METHOD( MatrixInvert15x15 )
		// {
		// 	double M[225] = {
	...
	TEST_CLASS( FastMatrixFrobeniusNormTest )
	{
		...
		void TestNorm( __in const T( &M )[m * n] )
		{
			...
			for ( size_t i = 0; i < m; i++ )
			{
				...
				{
					expected += ELEMENT( M, i * n + j ) * ELEMENT( M, i * n + j );
				}
			}

			expected = sqrt( expected );

			double actual = MatrixFrobeniusNorm< T, m, n >( M );
		...
		TEST_METHOD( Correctness0 )
		{
			...
			double norm = MatrixFrobeniusNorm< double, 2, 2 >( M );
			Assert::AreEqual( sqrt( 30.0 ), norm );
		}

		TEST_METHOD( MatrixFrobNorm5x5 )
		{
			double M[25] = {
				0.281129, 0.0515451, 0.0538386, 0.476397, 0.930885,
				0.391529, 0.272349, 0.407691, 0.384763, 0.752375,
			...
			TestNorm< double, 5, 5 >( M );
		}

		TEST_METHOD( MatrixFrobNorm10x10 )
		{
			double M[100] = {
				0.445356, 0.149549, 0.837978, 0.542875, 0.8668, 0.86734, 0.149997, 0.973244, 0.0240157, 0.898928,
				0.623209, 0.897471, 0.965051, 0.538636, 0.484395, 0.368528, 0.747179, 0.638155, 0.786596, 0.432414,
			...
			TestNorm< double, 10, 10 >( M );
		}

		TEST_METHOD( MatrixFrobNorm15x15 )
		{
			double M[225] = {
				0.67219, 0.431556, 0.548418, 0.459355, 0.375244, 0.933047, 0.863162, 0.419339, 0.943765, 0.916051, 0.567261, 0.231972, 0.520518, 0.080906, 0.450535,
				0.520529, 0.0419026, 0.120874, 0.867017, 0.225223, 0.889283, 0.676534, 0.645125, 0.967331, 0.228988, 0.845189, 0.639063, 0.640531, 0.675048, 0.783442,
